...
<?
	...
	$channel['theme']->setDescription($getDistrict->district_name.', '.$getOneSubRegion->subregions_name.', '.$region->country); 
?>
<?
	...
	<div class="contentpanel section-content">
		...
		@else 
			<div class="alert alert-info">
				<strong>{!!$channel['info']->channel_name.((!empty($getField->name)) ? ' '.$getField->name : '').' '.$getDistrict->district_name!!}</strong> chưa có thông tin nào! 
			</div>
		@endif
	</div>
