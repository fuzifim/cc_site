				...
				@if(count($channel['info']->joinAddress)>0)
					<div class="form-group">
						<div id="googleMap" style="width:100%; height:300px;">
							<iframe src="https://www.google.com/maps/embed/v1/place?key=AIzaSyC0VIzBsP4HTtHVp8Z1G2i8apmirMa27U8&amp;zoom=16&amp;q={{ $address }}" style="height: 300px; width: 100%; border: 0px;"></iframe>
						</div>
					</div>
				@endif
				<div class="row">
						...
						<div class="form-group">
							<div class="groupCompany">
								<div class="itemCompany">
									<h4 class="panel-title">@if(!empty($channel['info']->companyJoin->company)){{$channel['info']->companyJoin->company->company_name}}@else{{$channel['info']->channel_name}}@endif 
