			...
			<form id="formRegister">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="input-group">
							<span class="input-group-addon" id="basic-addon1"><i class="flag flag-{{mb_strtolower($channel['info']->joinAddress[0]->address->joinRegion->region->iso)}}"></i></span>
					...
					<div class="form-group">
						@if(!empty($channel['info']->joinAddress[0]->address->joinRegion->region->id))
							<input type="hidden" id="region" name="channelRegion" value="{{$channel['info']->joinAddress[0]->address->joinRegion->region->id}}">
						@endif 
					</div>
					<div class="form-group">
						@if(!empty($channel['info']->joinAddress[0]->address->joinSubRegion->subregion->id))
							<input type="hidden" name="channelSubregion" id="subRegion" value="{{$channel['info']->joinAddress[0]->address->joinSubRegion->subregion->id}}">
						@endif 
					</div>
					<div class="form-group">
