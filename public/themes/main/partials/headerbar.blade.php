<nav class="navbar navbar-default headerbar mb5">
	<div class="container-fluid">
	  <div class="navbar-header">
		...
		<a class="navbar-brand logo_header" href="{{route('channel.home',$channel['domainPrimary'])}}"><img class="" id="logoChannel" src="{!! config('app.url') !!}/assets/img/logo-red-white.svg" alt="{!!$channel['info']->channel_name!!}" title="{!!$channel['info']->channel_name!!}"></a>
	  </div>
