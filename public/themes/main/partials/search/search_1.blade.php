	...
	@foreach($getItems as $item)
		...
		@elseif($item['type']=='domain')
			...
			<div class="list-group-item">
				<h4 class="blog-title headTitle"><strong><a class="text-info siteLink" data-url="123" target="_blank" href="@if($domain->domain!=config('app.url'))http://{{$domain->domain}}.{{config('app.url')}}@endif">{{$domain->domain_title}}</a></strong></h4>
