<div class="leftpanel">
	...
	<div class="leftpanelinner">
		...
		<ul class="nav nav-pills nav-stacked nav-bracket mb10">
			...
			@endif 
			@if($channel['security']==true) 
			<li class="nav-parent {{(\Request::url()==route('post.add',$channel['domainPrimary'])) ? 'nav-active' : ''}}"><a href=""><i class="glyphicon glyphicon-cog"></i> <span>Quản lý</span></a> 
				<ul class="children" style="{{(\Request::url()==route('post.add',$channel['domainPrimary'])) ? 'display:block;' : ''}}"> 
