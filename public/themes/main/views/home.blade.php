	...
	<div class="mainpanel">
		...
		<div class="container panelRegisterSite">
			<div class="row row-pad-5">
				...
				<div class="col-md-6">
					<div class="channelPrice">Dùng thử miễn phí</div>
					<ul class="list-group">
						...
						<li class="list-group-item"><i class="glyphicon glyphicon-globe text-success"></i> Miễn phí tên miền dạng .{!! config('app.domain_register') !!}</li>
