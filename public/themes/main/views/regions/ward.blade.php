...
<?
	...
	$channel['theme']->setDescription($channel['info']->channel_name.' tại '.$getWard->ward_name.', '.$getOneDistrict->district_name.', '.$getOneSubRegion->subregions_name.', '.$region->country);
...
{!!Theme::partial('formSearch', array('region' => $channel['region']))!!}
	...
	<div class="contentpanel section-content">
		...
		<ol class="breadcrumb mb10" itemscope="" itemtype="http://schema.org/BreadcrumbList">
			...
			<li class="breadcrumb-item" itemprop="itemListElement">
				<a href="#" itemprop="item" class="" data-toggle="modal" data-target="#modalRegionDistrict">
					<span itemprop="name">{!!$getOneDistrict->district_name!!}</span> <span class="glyphicon glyphicon-menu-down"></span>
				</a>
				<meta itemprop="position" content="2" />
			</li>
			<li class="breadcrumb-item active" itemprop="itemListElement">
				<a href="#" itemprop="item" class="" data-toggle="modal" data-target="#modalRegionWard">
					<span itemprop="name">{!!$getWard->ward_name!!}</span> <span class="glyphicon glyphicon-menu-down"></span>
				</a>
		...
		<div class="row-pad-5">
			...
			<div class="col-md-3">
				@if($companyRelate && count($companyRelate)>0)
