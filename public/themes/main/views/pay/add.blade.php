		...
		<div class="panel panel-primary">
			<div class="panel-body">
				...
				<div class="form-group">
                    <input type="tel" pattern="[0-9]*" novalidate name="sizePriceNumber" id="inputPrice" class="form-control"placeholder="Nhập số tiền cần nạp" required >
					<code id="changePrice"></code>
                </div>
				<div class="alert alert-warning">
					<strong>Lưu ý!</strong> Số tiền nạp tối thiểu 20.000đ
				</div>
			</div><!-- panel-body -->
		</div><!-- panel-default -->
