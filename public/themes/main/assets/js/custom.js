...
jQuery(document).ready(function() {
   ...
   $("#lazy img.lazy").each(function(){
		$(this).attr("data-src", $(this).attr("src"));
		$(this).attr("src", "//cungcap.net/assets/img/loading.svg");
	});
   // Toggle Left Menu
   ...
   function reposition_searchform() {
      if(jQuery('#groupSearchForm').css('position') == 'relative') {
         jQuery('#groupSearchForm').insertBefore('#navbarSearch');
      } else {
         jQuery('#groupSearchForm').insertBefore('#insertFormSearch');
      }
   }
...
if($("#back-to-top").length){var scrollTrigger=100,backToTop=function(){$(window).scrollTop()>scrollTrigger?$("#back-to-top").addClass("show"):$("#back-to-top").removeClass("show")};backToTop(),$(window).on("scroll",function(){backToTop()}),$("#back-to-top").on("click",function(o){o.preventDefault(),$("html,body").animate({scrollTop:0},700)})}