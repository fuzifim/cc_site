...
{!!Theme::partial('headerbar', array('title' => 'Header'))!!}
	...
	<div class="contentpanel section-content">
		<?
			...
			$getAllSubRegion=\App\Model\Subregions::where('region_id','=',$channel['region']->id)->get(); 
		?>
				...
				<div class="panel panel-default">
					...
					<div class="list-group">
						@foreach($Keywords as $keyword)
							<li class="list-group-item"><a href="{{route('keyword.show',array($channel['domainPrimary'],urlencode(str_replace(' ', '+', $keyword->keyword))))}}">{{$keyword->keyword}}</a> <small><span class="time-update"><i class="glyphicon glyphicon-time"></i> {!!WebService::time_request($keyword->created_at)!!}</span> - Xem {{$keyword->view}}</small></li>
						@endforeach
					</div>
				</div>
			</div>
