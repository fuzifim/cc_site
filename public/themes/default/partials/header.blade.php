<header id="header">
	<div id="logo-group">
		<span id="logo"> <a href="{{route('channel.home',$channel['domainPrimary'])}}"><img src="//cungcap.net/themes/default/assets/img/logo-red-white.svg" alt="Cung Cấp"></a> </span>
	</div>
	<div class="pull-right">
		...
		<div class="btn-header pull-right">
			<span> <a href="#" title="Login"><i class="fa fa-user"></i></a> </span>
		</div>
