...
@section('seo')
<?php $data_seo = array(
         'title' => 'Doanh nghiệp tại '.$subregions->subregions_name.config('app.title_seo'),
         'keywords' => '',
         'description' => 'Thông tin các doanh nghiệp tại '.$subregions->subregions_name." - ".$regions->country,
         'og_title' => 'Doanh nghiệp tại '.$subregions->subregions_name.config('app.title_seo'),
          'og_description' => 'Thông tin các doanh nghiệp tại '.$subregions->subregions_name." - ".$regions->country,
          'og_url' => '',
										...
										<div class="btn-group" role="group">
											<div class="dropdown dropdown-lg">
												<ol class="breadcrumb" itemscope="" itemtype="http://schema.org/BreadcrumbList">
													...
													<li class="dropdown hidden-xs" itemprop="itemListElement">
														<a class="btn btn-default dropdown-toggle btn-menu" data-toggle="dropdown" href="javascript:void(0)" itemprop="item"><span itemprop="name">Quận/huyện</span> <span class="glyphicon glyphicon-menu-down"></span></a>
											...
											<input id="txt_search" type="text" class="form-control" placeholder="Doanh nghiệp: {{$subregions->subregions_name}}+{{$regions->country}}" value="<?php if(isset($txt) && strlen($txt)>0){ echo $txt;}?>"/>
