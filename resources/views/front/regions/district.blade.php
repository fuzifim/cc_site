...
@section('seo')
<?php $data_seo = array(
         'title' => 'Doanh nghiệp tại '.$districts->district_name.config('app.title_seo'),
         'keywords' => '',
         'description' => 'Thông tin các doanh nghiệp tại '.$districts->district_name." - ".$subregions->subregions_name." - ".$regions->country,
         'og_title' => 'Doanh nghiệp tại '.$districts->district_name.config('app.title_seo'),
          'og_description' => 'Thông tin các doanh nghiệp tại '.$districts->district_name." - ".$subregions->subregions_name." - ".$regions->country,
          'og_url' => '',
								...
								<div class="input-group" id="adv-search">
									<div class="input-group-btn">
										<div class="btn-group" role="group">
											...
											<input id="txt_search" type="text" class="form-control" placeholder="Doanh nghiệp: {{$districts->district_name}}+{{$subregions->subregions_name}}+{{$regions->country}}" value="<?php if(isset($txt) && strlen($txt)>0){ echo $txt;}?>"/>
