...
@section('seo')
<?php $data_seo = array(
         'title' => $regions->country.$subregions->subregions_name.$districts->district_name.config('app.title_seo'),
         'keywords' => '',
         'description' => '',
         'og_title' => '',
          'og_description' => '',
...
<div class="breadcrumbs_container pd-body clear">
	<div class=" container clear">
		{!! Breadcrumbs::render('front.location.distric',$regions,$subregions,$districts) !!}
	</div>
</div>
     ...
     <div class="row no-gutter cp_group_content">
    	...
    	<div class="col-md-12 col-sm-12 col-xs-12 item_cat_page find_contry_group find_location_container">
            <div class="content_details_cp_group content_location_ads clear">
                ...
                <h1> {{$districts->district_name}} <i class="fa fa-angle-right"></i> {{$subregions->subregions_name}} </h1>
                <!--Begin Code-->
