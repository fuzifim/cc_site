			...
			<td style="display: block !important; max-width: 800px !important; margin: 0 auto !important; clear: both !important;" width="100%">
				...
				<div style="width:98%;  margin: 0 auto; display: block;">
					<table style="background: #fff;" width="100%" cellpadding="0" cellspacing="0">
						<tr>
							<td style="text-align:center; background:url(@if(!empty($channel['info']->channelAttributeLogo->media->media_url_xs))http:{{$channel['info']->channelAttributeLogo->media->media_url_xs}}@else{{asset('assets/img/logo-default.jpg')}}@endif) no-repeat center center; height:150px; "></td>
						</tr>
						<tr>
								...
								<table width="100%" cellpadding="0" cellspacing="0">
									<tr>
										<td style="padding:0px; ">
											<h1 style="border-bottom: solid 1px #dadada; padding-bottom: 5px; text-align:center;">Yêu cầu đổi mật khẩu</h1>
										</td>
									</tr>
									<tr>
										<td style="padding: 0px;">
											Nhấn vào đường dẫn này để đổi mật khẩu của bạn: {{route('forgot.password.reset',array($channel['domain']->domain,$token))}}
										</td>
									</tr>
								</table>
							</td>
						...
						<tr style="border-top: solid 1px #dadada; background: #3b5998;">
							<td align="center" valign="" style="color: #fff;padding-top: 10px;">
								<a href="{{route('channel.home',$channel['domain']->domain)}}" style="color: #fff; font-weight:bold; ">{{$channel['info']->channel_name}}</a> {{$channel['info']->channel_description}} 
