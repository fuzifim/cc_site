                    ...
                    <div class="panel">
                        <div class="panel-body">
                            <div id="post-form-container" class="col-sm-12 col-md-12 col-lg-12">
                                ...
                                <form id="post-item-form" action="{{ route('front.ads.update',array($id_template,$ads->id)) }}" method="post" accept-charset="utf-8" role="form" class="form-horizontal">
									...
									<div class="form-group mrbt-5">
                                        <div class="col-sm-9 col-xs-12 col-sm-offset-3 col-xs-offset-0">
                                            <div class="alert alert-warning alert_km clear">
												...
												<div class="pull-left title-km">Khuyến mãi</div> <div class="pull-left" ><input id="km" name="km" type="checkbox" value="1" @if(strlen($ads->ads_promotion)>0) checked @endif autocomplete="off"/></div>
												</label>
											</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group upload_images">
                                        <label class="col-sm-3 col-xs-12 control-label" for="">Tải ảnh <span class="text-danger">(*)</span></label>
                                        <div class="col-sm-9 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 col-xs-12">
                                            <select id="category_option_select" class="form-control cat_manage_s" name="category_option">
                                 ...
                                 <div id="category_option_product_seleted" class="container_product clear" @if($ads->category_option_ads_id !=2)style="display:none;" @endif>
									...
									<div class="form-group tag_container_value_set" @if(count($tags)>0) style="display:block;" @else  style="display:none;" @endif>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-3 col-md-9 col-ms-9 col-xs-12 center_mobile">
                                             <button class="btn btn-primary" type="submit" name="send">Lưu
                                              ...
                                              <a class="btn btn-default mr-l-10" href="{{ route('user.ads.manager',$id_template) }}">
