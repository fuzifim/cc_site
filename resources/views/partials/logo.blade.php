<!-- Cropping modal -->
    <div class="modal fade" id="logo-modal" aria-hidden="true" aria-labelledby="logo-modal-label" role="dialog" tabindex="-1">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <form class="avatar-form" action="{{ route('changelogo') }}" enctype="multipart/form-data" method="post">
            <input type="hidden" name="_token" value="{{ csrf_token() }}" >

            <div class="modal-header">
              <button class="close" data-dismiss="modal" type="button">&times;</button>
              <h4 class="modal-title" id="avatar-modal-label">Đổi Logo</h4>
            </div>
            <div class="modal-body">
              <div class="avatar-body">
                ...
                <div class="avatar-upload">
                  <input class="template-value" name="template-value" type="hidden" value="<?php if(isset($id_template) && strlen($id_template)>0): echo $id_template; endif; ?>">
